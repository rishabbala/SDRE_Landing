...
def get_position(xt, yt, xn, yn, R):
    ...
    for i in range(len(key_points_dir_global[0])):
        key_points_dir_global[0][i] = float(key_points_dir_global[0][i])*(0.0-z)/float(key_points_dir_global[2][i]) + xn
        key_points_dir_global[1][i] = float(key_points_dir_global[1][i])*(0.0-z)/float(key_points_dir_global[2][i]) + yn
